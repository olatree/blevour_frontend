...
//       const reports = Array.isArray(reportPayload) ? reportPayload : [];
...
//         if (sid) {
//           existingComments[sid] = report.classTeacherComment || "";
//         }
//       });
...
//               You can only enter comments for your assigned class.
//             </p>
//           )}
//         </div>
...
//               disabled={!selectedAcademicUnit || isClassTeacherOnly}
//               onChange={(e) => {
