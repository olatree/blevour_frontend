...
export default function ManageStudents() {
  ...
  const openEditModal = (enrollment) => {
    ...
    const academicUnitId =
      enrollment.academicUnitId?._id ||
      enrollment.academicUnitId ||
      enrollment.classId?.academicUnitId ||
      "";
  ...
  const submitEdit = async (e) => {
    ...
    try {
      ...
      formData.append("academicUnitId", editForm.academicUnitId);
