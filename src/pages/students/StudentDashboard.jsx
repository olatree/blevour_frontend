...
export default function StudentDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-3 sm:p-4 md:p-6">
      <div className="mb-5 rounded-2xl bg-gradient-to-r from-cyan-500 to-gray-700 p-6 text-white shadow-sm">
...
const DashboardCard = ({ icon, title, text, to }) => (
  ...
  >
    <div className="mb-3 flex h-11 w-11 items-center justify-center rounded-xl bg-cyan-50 text-cyan-600">
      {icon}
    </div>
