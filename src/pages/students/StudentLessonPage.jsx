...
//   const fetchSubjects = async (profile) => {
//     try {
//       setFilterLoading(true);
//       setError("");

//       const academicUnitId =
//         profile?.academicUnitId?._id || profile?.academicUnitId;
...
//       const academicUnitId =
//         studentProfile?.academicUnitId?._id || studentProfile?.academicUnitId;

//       const classId =
//         studentProfile?.classId?._id ||
//         studentProfile?.classId ||
//         studentProfile?.enrollment?.classId?._id ||
//         studentProfile?.enrollment?.classId;

//       const armId =
//         studentProfile?.armId?._id ||
//         studentProfile?.armId ||
//         studentProfile?.enrollment?.armId?._id ||
//         studentProfile?.enrollment?.armId;
...
//           <b>{studentProfile.academicUnitId?.name || "Academic Unit"}</b>
//           {" • "}
//           {studentProfile.classId?.name ||
//             studentProfile.enrollment?.classId?.name ||
//             "Class"}
//           {" "}
//           {studentProfile.armId?.name ||
//             studentProfile.enrollment?.armId?.name ||
//             ""}
//         </div>
//       )}
...
const StudentLessonsPage = () => {
  ...
  const fetchStudentProfile = async () => {
    try {
      ...
      setStudentProfile(payload);
      console.log("Student profile fetched:", payload);
      return payload;
    } catch (err) {
      setError(err.response?.data?.message || "Failed to load student profile");
      return null;
  ...
  const fetchSubjects = async (profile) => {
    try {
      ...
      if (!academicUnitId) {
            setSubjects([]);
            setError("Your academic unit is missing. Please contact admin.");
            return;
          }
