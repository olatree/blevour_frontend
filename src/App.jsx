...
import HeadTeacherComment from "./pages/admin/HeadTeacherComment";
...
import AcademicUnitsPage from "./pages/admin/AcademicUnitsPage";
import FeeTemplateManagement from "./pages/admin/FeeTemplateManagement";
import CashierPaymentPage from "./pages/admin/fees/CashierPaymentPage";
import HeadTeacherManagement from "./pages/admin/HeadTeacherManagement";
      ...
      <Route element={<ProtectedRoute />}>
        <Route path="/admin" element={<AdminLayout />}>
          ...
          >
            ...
            <Route path="head-teachers" element={< HeadTeacherManagement />}/>
            ...
            <Route path="head-teacher-comments" element={<HeadTeacherComment />} />
            ...
            <Route path="/admin/fees/templates" element={<FeeTemplateManagement />} />
            <Route path="/admin/fees/cashier-payment" element={<CashierPaymentPage />} />
            ...
            <Route path="/admin/academic-units" element={<AcademicUnitsPage />} />
          </Route>
        </Route>
      </Route>
