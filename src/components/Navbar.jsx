...
export default function Navbar() {
  ...
  return (
    <nav className="bg-cyan-600 text-white fixed w-full top-0 left-0 shadow-md z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-16">
        {/* Logo */}
        <a href="/" className="flex items-center gap-2">
          <img src="./blevour_logo.jpeg" alt="School Logo" className="h-8 w-8" />
          <span className="text-xl font-bold">Blevour Schools</span>
        </a>
