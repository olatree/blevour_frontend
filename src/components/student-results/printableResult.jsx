...
export default function PrintableResult({
  ...
  return (
    <div className="bg-white text-black print:p-0">
      <div className="mx-auto w-[210mm] min-h-[297mm] p-6 text-[10px] print:w-full print:min-h-0">
        ...
        <div className="relative mb-3 rounded bg-cyan-600 p-3 text-white">
  <img
    src="/blevour_logo.jpeg"
    alt="School Logo"
    className="absolute left-3 top-1/2 h-16 w-16 -translate-y-1/2 rounded-full border object-contain"
  />
  ...
  <div className="text-center">
    ...
    <p>1b, Olorunishola Street, Awodi-Ora, Ajeguunle - Apapa Lagos.</p>

    <p>Phone: 08033525269, 09123744861</p>
        ...
        <div className="mb-3 grid grid-cols-3 gap-3 rounded bg-blue-50 p-3">
          ...
          <div className="flex justify-center">
            <img
              ...
              alt="Student"
              className="h-28 w-28 rounded-full border-2 border-cyan-600 object-cover"
            />
          </div>
  ...
  <div className="bg-cyan-600 py-1 text-center text-[9px] font-bold text-white">
    FEE STATUS
  </div>
