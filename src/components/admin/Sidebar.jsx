  ...
  <NavLink
    ...
    className={({ isActive }) =>
      `flex items-center gap-2 rounded-lg px-3 py-2 text-sm transition-colors ${
        isActive
          ? "bg-cyan-200 font-medium text-gray-900"
...
export default function Sidebar({ isOpen, onClose }) {
  ...
  const [principalMenus, setPrincipalMenus] = useState({
   ...
   const [headTeacherMenus, setHeadTeacherMenus] = useState({
    cbt: false,
    teacher: false,
    result: false,
    lessons: false,
  ...
  const toggleHeadTeacherMenu = (menu) => {
    setHeadTeacherMenus((prev) => ({ ...prev, [menu]: !prev[menu] }));
  };
  ...
  const AdminSidebar = () => (
    <>
      ...
      <NavItem
        to="/admin/head-teachers"
        label="Manage Head Teachers"
        icon={<UserCog size={18} />}
        onClick={onClose}
      />
  ...
  const HeadTeacherSidebar = () => (
    <>
      ...
      <CollapsibleSection
        title="Lesson Management"
        icon={<NotebookTabs size={18} />}
        isOpen={headTeacherMenus.lessons}
        onToggle={() => toggleHeadTeacherMenu("lessons")}
      >
        <NavItem
          to="/admin/lessons/create"
          label="Create Lesson"
      ...
      <CollapsibleSection
        title="Manage CBT"
        icon={<ClipboardCheck size={18} />}
        isOpen={headTeacherMenus.cbt}
        onToggle={() => toggleHeadTeacherMenu("cbt")}
      >
        <NavItem
          to="/admin/cbt/banks"
          label="Question Banks"
      ...
      <CollapsibleSection
        title="Teacher Management"
        icon={<Users size={18} />}
        isOpen={headTeacherMenus.teacher}
        onToggle={() => toggleHeadTeacherMenu("teacher")}
      >
      ...
      <CollapsibleSection
        title="Result Management"
        icon={<FileText size={18} />}
        isOpen={headTeacherMenus.result}
        onToggle={() => toggleHeadTeacherMenu("result")}
      >
        <NavItem
          to="/admin/enter-results"
          label="Enter Result"
  ...
  const TeacherSidebar = () => (
    <>
      ...
      <CollapsibleSection
        title="Manage CBT"
        icon={<ClipboardCheck size={18} />}
        isOpen={teacherMenus.cbt}
        onToggle={() => toggleTeacherMenu("cbt")}
      >
    ...
    <>
      ...
      >
        <div className="flex flex-shrink-0 items-center justify-between border-b p-4 md:justify-center">
          <h1 className="text-xl font-bold text-cyan-600">School Admin</h1>
